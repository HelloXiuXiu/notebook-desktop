...
var TonicAccordion = class extends Tonic {
  defaults() {
    return {
      multiple: false
    };
...
var TonicAccordionSection = class extends Tonic {
  static stylesheet() {
    return `
...
var TonicBadge = class extends Tonic {
  defaults() {
    return {
      count: 0
    };
...
var TonicButton = class extends Tonic {
  get value() {
...
var TonicChart = class extends Tonic {
  static stylesheet() {
    return `
      tonic-chart {
        display: inline-block;
...
var TonicCheckbox = class extends Tonic {
  constructor() {
    super();
...
var TonicForm = class extends Tonic {
  static isNumber(s) {
...
var TonicIcon = class extends Tonic {
  defaults() {
    return {
      size: "25px",
...
var TonicInput = class extends Tonic {
  constructor() {
    super();
    this._modified = false;
  }
...
var TonicLoader = class extends Tonic {
  constructor() {
    super();
...
var TonicPopover = class extends Tonic {
  constructor() {
    super();
...
var TonicProfileImage = class extends Tonic {
  get value() {
    const state = this.state;
...
var TonicProgressBar = class extends Tonic {
  set value(value) {
...
var TonicRange = class extends Tonic {
  defaults() {
    return {
      width: "250px",
      disabled: false,
...
function isDayFirst() {
  ...
  if (formatter) {
    const output = formatter.format(/* @__PURE__ */ new Date(0));
...
var RelativeTime = class {
  ...
  timeElapsed({ date = this.date, locale = this.locale } = {}) {
    const ms = (/* @__PURE__ */ new Date()).getTime() - date.getTime();
  ...
  timeAhead({ date = this.date, locale = this.locale } = {}) {
    const ms = date.getTime() - (/* @__PURE__ */ new Date()).getTime();
    const sec = Math.round(ms / 1e3);
    const min = Math.round(sec / 60);
    const hr = Math.round(min / 60);
    const day = Math.round(hr / 24);
...
var TonicRelativeTime = class extends Tonic {
  render() {
...
var TonicRouter = class extends Tonic {
  constructor() {
    super();
...
var TonicSelect = class extends Tonic {
  defaults() {
    return {
      disabled: false,
      invalid: false,
...
var TonicSprite = class extends Tonic {
  static stylesheet() {
    return `
      tonic-sprite svg {
        visibility: hidden;
...
var TonicSplitLeft = class extends Tonic {
  render() {
    if (this.props.width) {
      this.style.width = this.props.width;
    }
...
var TonicSplitTop = class extends Tonic {
  render() {
...
var TonicSplit = class extends Tonic {
  constructor() {
    super();
    this.left = null;
    this.right = null;
...
var TonicTabs = class extends Tonic {
  constructor(o) {
    super(o);
...
var TonicTabPanel = class extends Tonic {
  static stylesheet() {
    return `
      tonic-tab-panel {
        display: block;
...
var TonicTab = class extends Tonic {
  render() {
...
var TonicTextarea = class extends Tonic {
  mutate(e) {
...
var TonicTooltip = class extends Tonic {
  connected() {
...
var TonicToasterInline = class extends Tonic {
  defaults() {
    return {
      display: "true"
    };
...
var TonicToggle = class extends Tonic {
  constructor() {
    super();
    this._modified = false;
  }
...
var version = tonic_default.version;
...
var once = false;
Components.Tonic = tonic_default;
function Components(Tonic2) {
  if (once) {
    return;
  }
  once = true;
  Tonic2.add(TonicAccordion, "tonic-accordion");
  Tonic2.add(TonicAccordionSection, "tonic-accordion-section");
  Tonic2.add(TonicBadge, "tonic-badge");
  Tonic2.add(TonicButton, "tonic-button");
  Tonic2.add(TonicChart, "tonic-chart");
  Tonic2.add(TonicCheckbox, "tonic-checkbox");
  Tonic2.add(TonicDialog, "tonic-dialog");
  Tonic2.add(TonicForm, "tonic-form");
  Tonic2.add(TonicInput, "tonic-input");
  Tonic2.add(TonicIcon, "tonic-icon");
  Tonic2.add(TonicLoader, "tonic-loader");
  Tonic2.add(TonicPanel, "tonic-panel");
  Tonic2.add(TonicPopover, "tonic-popover");
  Tonic2.add(TonicProfileImage, "tonic-profile-image");
  Tonic2.add(TonicProgressBar, "tonic-progress-bar");
  Tonic2.add(TonicRange, "tonic-range");
  Tonic2.add(TonicRelativeTime, "tonic-relative-time");
  Tonic2.add(TonicRouter, "tonic-router");
  Tonic2.add(TonicSelect, "tonic-select");
  Tonic2.add(TonicSprite, "tonic-sprite");
  Tonic2.add(TonicSplit, "tonic-split");
  Tonic2.add(TonicSplitLeft, "tonic-split-left");
  Tonic2.add(TonicSplitRight, "tonic-split-right");
  Tonic2.add(TonicSplitTop, "tonic-split-top");
  Tonic2.add(TonicSplitBottom, "tonic-split-bottom");
  Tonic2.add(TonicTabPanel, "tonic-tab-panel");
  Tonic2.add(TonicTab, "tonic-tab");
  Tonic2.add(TonicTabs, "tonic-tabs");
  Tonic2.add(TonicTextarea, "tonic-textarea");
  Tonic2.add(TonicTooltip, "tonic-tooltip");
  Tonic2.add(TonicToasterInline, "tonic-toaster-inline");
  Tonic2.add(TonicToaster, "tonic-toaster");
  Tonic2.add(TonicToggle, "tonic-toggle");
}
var components_default = Components;

// src/index.js
components_default(tonic_default);
